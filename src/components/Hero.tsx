  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16 relative z-10 text-center animate-fade-in">
        ...
        <div className="bg-primary/95 backdrop-blur-sm inline-block px-8 py-6 rounded-2xl mb-8 shadow-2xl border-4 border-white/30">
          <p className="text-5xl md:text-6xl lg:text-8xl font-black text-white mb-0">
            ¡Evoluciona Ya!
          </p>
        </div>
        
        <p className="text-lg md:text-xl lg:text-2xl text-white mb-10 max-w-3xl mx-auto font-semibold drop-shadow-lg">
